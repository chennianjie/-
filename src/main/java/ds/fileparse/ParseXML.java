...
//    {
//        try {
//            pw = new PrintWriter(new File("C:\\Users\\U6079438\\Desktop\\PDP\\Done\\pw.txt"));
...
//    }
    ...
    public ParseXML(File file, String uuid) {
        this.file = file;
        this.uuid = uuid;
    }
    ...
    public void run() {
        ...
        try {
            ...
            ProcessBatchQueues.IncrementalQueue2.add(DUMMY);
        }
...
class GetStuInfoHandler extends DefaultHandler {
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        if(qName.equals(PROPERTY)){
            ...
            //ParseXML.pw.println(inc.toString());
            ProcessBatchQueues.IncrementalQueue2.add(inc);//使用阻塞队列
